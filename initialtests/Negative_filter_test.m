%Created by Alexis. Was used with the goal of creating negative filters
%(color and grayscale). Did not use for final project since we discovered a
%simpler command that would not require a for loop
